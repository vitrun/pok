...
print('select a valid e so that there is no number that is common factor of '
      'e and 72')
...
# The pair of numbers (n, e) = (91, e) forms the public key and can be made
# available to anyone whom we wish to be able to send us encrypted messages.
print('public key: ', (n, e))

# Private Key d is the inverse of e modulo (p - 1)(q – 1):
# ed = 1 mod (p − 1)(q − 1)
d, tmp = 0, (p - 1) * (q - 1)
